...
# MAIN script that runs Python and R - each grey "chunk" can be defined based on the type of script to be run
# There are a number of options that can be included in the brackets at the beginning of each chunk 
...
#setwd("C:/Users/rwjac/Desktop/Water_Watch_Prototype")
...
```{python}
onedayprcp_df = USGS_prcpdf.iloc[576:672]
twodayprcp_df = USGS_prcpdf.iloc[480:672]
threedayprcp_df = USGS_prcpdf.iloc[384:672]
fivedayprcp_df = USGS_prcpdf.iloc[192:672]
