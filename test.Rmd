...
forecast_df$status[forecast_df2$Ecoli_pred >= 235 & forecast_df2$Ecoli_pred < 350] <- "Caution"
forecast_df$status[forecast_df2$Ecoli_pred >= 350 & forecast_df2$Ecoli_pred < 750] <- "Warning"
forecast_df$status[forecast_df2$Ecoli_pred >= 750] <- "Danger"
