...
#JBlvd Model - Ecoli = 2160 + 92.53*(SUM(LN(Flow),SQUAREROOT(rainfall))) - 1305*(LOG10(TMAX))

JBlvd_pred <- 2160 + 92.53*(log(forecast_df["JBlvd","flow"])+sqrt(forecast_df["JBlvd","onedayprcp"])) - 1305*(log10(forecast_df["JBlvd","temp"]))
...
forecast_df <- forecast_df %>% 
  mutate(tag = paste0("<a href=", url,">", url, "</a>"))
